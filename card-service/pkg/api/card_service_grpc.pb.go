...
const (
	...
	CardService_ListCards_FullMethodName  = "/card_service.CardService/ListCards"
	CardService_ChargeCard_FullMethodName = "/card_service.CardService/ChargeCard"
	CardService_UpdateCard_FullMethodName = "/card_service.CardService/UpdateCard"
...
func (c *cardServiceClient) ChargeCard(ctx context.Context, in *ChargeCardRequest, opts ...grpc.CallOption) (*ChargeCardResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChargeCardResponse)
	err := c.cc.Invoke(ctx, CardService_ChargeCard_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCardServiceServer) ChargeCard(context.Context, *ChargeCardRequest) (*ChargeCardResponse, error) {
...
func _CardService_ChargeCard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChargeCardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CardServiceServer).ChargeCard(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CardService_ChargeCard_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CardServiceServer).ChargeCard(ctx, req.(*ChargeCardRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CardService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CardService_ChargeCard_Handler,
		},
		{
